...
# --- COLOR PALETTE ---
SCORE_BG = (250, 235, 205)     # Beige Scorecard background
MENU_BG = (252, 228, 172)      # #fce4ac - Start and End Page Background
DARK_BLUE = (27, 117, 161)     # Deep Blue (Menu Buttons)

# Custom Colors from Prompt
P1_BOX = (4, 170, 210)         # #04aad2 - P1 Cyan Box & P1 Roll Button
P2_BOX = (231, 85, 78)         # #e7554e - P2 Red Box & P2 Roll Button

# Dynamic Table Backgrounds (Lighter shades to contrast with the buttons/boxes)
P1_BG = (164, 218, 232)        # Light cyan theme for P1 Turn
P2_BG = (242, 179, 174)        # Light red theme for P2 Turn

DICE_UNROLLED = (95, 102, 113) # Dark Gray for unrolled dice
WHITE, BLACK = (255, 255, 255), (40, 40, 40)
CYAN_HOLD = (0, 255, 255)      # Bright Cyan for held dice border
YELLOW = (255, 215, 0)
...
class YatzyGUI:
    def __init__(self, screen):
        ...
        self.pvp_btn = pygame.Rect(300, 200, 300, 60)
        self.ai_btn = pygame.Rect(300, 280, 300, 60)
        self.custom_ai_btn = pygame.Rect(300, 360, 300, 60)
    ...
    def draw_menu(self):
        ...
        for btn, text in [(self.pvp_btn, "Player vs Player"), 
                          (self.ai_btn, "Player vs AI (Minimax)"),
                          (self.custom_ai_btn, "Player vs AI (Rule Based)")]:
    ...
    def draw_game(self, dice, scorecards, current_player, game_mode):
        # Determine active theme colors based on whose turn it is
    ...
    def draw_scorecard(self, scorecards, current_player, game_mode):
        ...
        left_col = cats[:6]   # 1-6 Left Column
        right_col = cats[6:]  # 3x, 4x, etc. Right Column

        # Left Column (1-6)
        self._draw_column(scorecards, left_col, start_x + 20, start_y + 20)
        
        # Center Divider Line
        # We use a neutral color for the divider (a light brown/orange from P2 palette for aesthetics)
        ...
        # Bonus lies on the left column (bottom of 1-6)
