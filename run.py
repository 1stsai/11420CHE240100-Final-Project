...
from agents import YatzyAgent, RuleBasedAgent1, RuleBasedAgent2, ReflexAgent

def get_agent(agent_name):
    """Helper to instantiate agents based on CLI string."""
    if agent_name == 'minimax': return YatzyAgent()
    elif agent_name == 'rule1': return RuleBasedAgent1()
    elif agent_name == 'rule2': return RuleBasedAgent2()
...
def main():
    ...
    parser.add_argument('--p1', type=str, choices=['reflex', 'minimax', 'rule1', 'rule2'], default='rule2', help='Agent type for Player 1')
    parser.add_argument('--p2', type=str, choices=['reflex', 'minimax', 'rule1', 'rule2'], default='rule1', help='Agent type for Player 2')
    ...
    agents = {
        ...
        "AI_RULE1": RuleBasedAgent1(),
        "AI_RULE2": RuleBasedAgent2()
    }
